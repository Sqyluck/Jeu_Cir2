...
function preload() {
    ...
    game.load.spritesheet('dark', 'assets/dark-fou2.png', 32,48);
...
function initAffichage() {
    ...
    npcdisp = game.add.text(2*game.height/3,  40, 'Npcs:'+npcsLeft+'/'+npcs, { font: "15px Arial", fill: "#ffffff", align: "center" });
